        ...
        <main class="main-content">
            ...
            <section class="content-form">
                <form action="${pageContext.request.contextPath}/admin/students/update" method="POST">
                    ...
                    <%-- Hidden input to send the student's ID with the form --%>
                    ...
                    <div class="form-group">
    					...
    					<select id="department" name="department" required>
        					...
        					<option value="CSD" ${student.department == 'CSD' ? 'selected' : ''}>CSD</option>
        					<option value="CSC" ${student.department == 'CSC' ? 'selected' : ''}>CSC</option>
